-- CreateEnum
CREATE TYPE "Role" AS ENUM ('PM', 'DESIGNER', 'DEVELOPER', 'QA');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMMENTED', 'PROJECT_INVITE', 'MEMBER_JOINED', 'DEADLINE_APPROACHING');
...
-- AddForeignKey
ALTER TABLE "task_label_map" ADD CONSTRAINT "task_label_map_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "task_label_map" ADD CONSTRAINT "task_label_map_label_id_fkey" FOREIGN KEY ("label_id") REFERENCES "task_labels"("id") ON DELETE CASCADE ON UPDATE CASCADE;
